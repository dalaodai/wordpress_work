                ...
                $html .= '<div class="eael-content-timeline-block">
                    ...
                    $html .= '<div class="eael-content-timeline-content">';
                        ...
                        if( 'yes' == $settings['eael_show_excerpt'] ) {
                            $html .= '<p>' . implode(" ", array_slice(explode(" ", ((get_the_content() ? get_the_content() : get_the_content()))), 0, $settings['eael_excerpt_length'])) . $settings['excerpt_expanison_indicator'] . '</p>';
                        }
